...
const experienceData = [
  {
    ...
    bullets: [
      'Developed a ReactJS-based web application to simplify government job applications, utilizing Ant Design, Tailwind CSS, and Axios for a seamless user experience.',
      'Designed a feature for users to easily discover and apply for the latest job openings using dynamic, customizable forms.',
      'Built a robust admin dashboard for managing job postings, user applications, and order tracking, leveraging MongoDB for efficient data handling.',
    ],
  },
  {
    ...
    bullets: [
      'Developed multilingual product detail pages using ReactJS, incorporating NPM modules for enhanced functionality.',
      'Utilized React, React Hooks, Redux, and React-Router to create scalable, reusable components and implement smooth app routing.',
      'Collaborated with clients to gather requirements, refine UI/UX designs, and improve performance for a better user experience.',
    ],
  },
];
