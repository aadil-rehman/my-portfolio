...
import { StyledHeroSection, StyledBigTitle, StyledSubTitle, StyledThree } from './styles';
...
const Hero = () => {
  ...
  const two = <StyledBigTitle>Aadil Rehman</StyledBigTitle>;
  const three = (
    <StyledThree>
      <StyledSubTitle slate>
        Driving innovation with scalable, high-performance web and mobile apps.
      </StyledSubTitle>
    </StyledThree>
  );
  const four = (
